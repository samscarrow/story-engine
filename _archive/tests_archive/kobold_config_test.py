...
async def test_kobold_config(config_name: str, params: dict, prompt: str) -> dict:
    ...
    # Base payload
    payload = {"prompt": prompt, "max_context_length": 4096, "max_length": 200}
...
async def main():
    ...
    configs = [
        {
            ...
            "params": {"temperature": 0.1, "top_p": 0.5, "top_k": 10, "rep_pen": 1.0},
        },
        {
    ...
    for config in configs:
        ...
        result = await test_kobold_config(config["name"], config["params"], prompt)
