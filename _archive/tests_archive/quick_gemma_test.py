        ...
        try:
            ...
            if json_start >= 0 and json_end > json_start:
                ...
                if 'emotional_shift' in parsed:
                    ...
                    print(f"📊 Emotions: doubt={shifts.get('doubt', 0)}, fear={shifts.get('fear', 0)}")
...
async def compare_response_times():
    ...
    prompts = [
        ...
        ("Medium", "You are a character. Return JSON with dialogue and thought fields."),
        ("Long", "You are simulating Pontius Pilate in a complex moral dilemma. Return a detailed JSON response with dialogue, thought, action, and emotional_shift fields showing his internal conflict.")
    ]
