...
class CharacterSimulation:
    ...
    async def run_scene(
        self, character: CharacterState, scene: Dict[str, Any]
    ) -> Optional[Dict]:
    ...
    def display_emotional_journey(self):
        ...
        print(
            f"{'Scene':<20} {'Anger':>7} {'Doubt':>7} {'Fear':>7} {'Comp':>7} {'Conf':>7}"
        )
        print("-" * 70)
        ...
        for result in self.results:
            ...
            print(
                f"{scene:<20} {emotions['anger']:>7.2f} {emotions['doubt']:>7.2f} "
...
async def run_pilate_trial():
    ...
    print(
        f"📍 Initial state: Confidence={pilate.emotional_state.confidence:.2f}, "
