...
async def test_lmstudio_setup():
    ...
    try:
        ...
        if not is_available:
            ...
            print("   • Check that the server is started (look for green 'Server Running' indicator)")
        ...
        try:
            ...
            try:
                ...
                if missing_keys:
                    ...
                    print("💡 Your model might need better prompting or a different model")
                else:
...
async def run_real_llm_emotional_test():
    ...
    print(f"😰 Initial emotions: Doubt={test_character.emotional_state.doubt:.1f}, Fear={test_character.emotional_state.fear:.1f}")
    print()
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            print(f"🌡️ Emotional temperature: {test_character.emotional_state.modulate_temperature():.2f}")
            print()
    ...
    print("=" * 50)
    print("✅ If you see varied, contextual responses above, your setup is working perfectly!")
    ...
    recommendations = [
        {
            ...
            "size": "~4GB",
            "pros": ["Excellent instruction following", "Good JSON output", "Fast inference"],
