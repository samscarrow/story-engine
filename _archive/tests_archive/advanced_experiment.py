...
class EnhancedMockLLM(MockLLM):
    ...
    async def generate_response(
        ...
        return LLMResponse(
            content, {"model": "enhanced_mock", "temperature": temperature}
        )
...
async def character_deep_dive():
    ...
    base_pilate = CharacterState(
        ...
        emotional_state=EmotionalState(
            anger=0.3, doubt=0.7, fear=0.6, compassion=0.3, confidence=0.4
        ),
    ...
    scenarios = [
        (
            "Initial questioning",
            "You first encounter Jesus. He's been brought before you accused of claiming to be King of the Jews.",
        ),
        (
            "Private interrogation",
            "Alone with the prisoner, you question him about his alleged kingdom and his silence before accusers.",
        ),
        (
            "Crowd pressure",
            "The crowd grows violent, demanding crucifixion. The religious leaders insist he must die.",
        ),
        (
            "Wife's intervention",
            "Your wife sends word: 'Have nothing to do with this righteous man. I suffered much in a dream because of him.'",
        ),
        (
            "Final decision",
            "You must choose: release Jesus and risk rebellion, or condemn him against your conscience.",
        ),
        (
            "Aftermath",
            "The deed is done. Jesus hangs on the cross. Darkness covers the land.",
        ),
    ]
    ...
    for scene_name, situation in scenarios:
        ...
        result = await engine.run_simulation(
            current_pilate, situation, emphasis="neutral", temperature=0.8
        )
        ...
        print(
            f"😰 Current state: Doubt={emotional_state.doubt:.2f}, Fear={emotional_state.fear:.2f}, Compassion={emotional_state.compassion:.2f}"
        )
    ...
    variants = {
        "The Ruthless Administrator": {
            ...
            "emotional_state": EmotionalState(
                anger=0.6, doubt=0.2, fear=0.3, compassion=0.1, confidence=0.8
            ),
        ...
        "The Tormented Idealist": {
            ...
            "emotional_state": EmotionalState(
                anger=0.2, doubt=0.9, fear=0.5, compassion=0.8, confidence=0.3
            ),
    ...
    for variant_name, variant_config in variants.items():
        ...
        for emphasis in ["power", "fear", "compassion"]:
            result = await engine.run_simulation(
                variant_pilate, test_situation, emphasis=emphasis, temperature=0.7
            )
    ...
    for temp in temperatures:
        ...
        for i in range(3):
            result = await engine.run_simulation(
                base_pilate, situation, emphasis="doubt", temperature=temp
            )
