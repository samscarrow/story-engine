...
async def evaluate_two_stage_pipeline(model_identifier: str, character_id: str):
    ...
    print(f"--- Starting Two-Stage Pipeline Evaluation for model: {model_identifier} ---")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate a two-stage storytelling pipeline using the POML framework.")
    parser.add_argument("--model", required=True, help="The model identifier to evaluate.")
