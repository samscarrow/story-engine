...
def create_env_config(
    wallet_dir: str, db_user: str, db_dsn: str, output_file: str = ".env.oracle"
):
...
def main():
    parser = argparse.ArgumentParser(
        description="Set up Oracle wallet for story engine"
    )
    ...
    parser.add_argument(
        "--env-file", default=".env.oracle", help="Environment file to create"
    )
