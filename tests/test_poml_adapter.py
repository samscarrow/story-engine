...
def test_scene_prompt_renders_string():
    ...
    prompt = adapter.get_scene_prompt(beat=beat, characters=characters, previous_context="")
...
def test_dialogue_prompt_renders_string():
    adapter = StoryEnginePOMLAdapter()
    character = {"id": "c1", "name": "Alice", "role": "protagonist", "traits": ["brave"]}
    scene = type("S", (), {"__dict__": {"name": "Setup", "situation": "A quiet room", "emphasis": {"c1": "neutral"}, "goals": {"c1": "greet"}, "sensory": {}}})()
