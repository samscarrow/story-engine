...
class PilateStubOrchestrator:
    async def generate(self, prompt: str, **kwargs):
        ...
        if "Rate the following" in prompt or "Story Content (Excerpt)" in prompt or "expert literary critic" in system_prompt:
            return PilateStubResponse(
